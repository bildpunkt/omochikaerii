<template>
  <div class="container">
    ...
    <p>
      Currently {{ global.completedEntryCount }} (weight: <code v-html="global.completedEntryWeight" />) out of the {{ global.entryCount }} total entries (weight: <code v-html="global.entryWeight" />) have been finished, amounting to about {{ global.completedPercentage }}% completion! The list is weighted by the approximate time a single entry
